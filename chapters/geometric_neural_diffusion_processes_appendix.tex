...
% This is actually a really strong constraint on the model class, and as soon as one goes beyond linearity (of the posterior w.r.t.
...
\begin{proposition}
	...
	We have that $\lim_{t_0 \to 0} \pi_{t_0} = \pi_0$ where $\pi_0$ admits a density w.r.t.
