...
As such, the Eular-Maruyama scheme \emphhyperref{def:distribution-converge-rv}{converges in distribution} to the solution to the original stochastic differential equation as we decrease step size of the solution.
