...
Firstly, we look at \emphhyperref{tensor fields}{}.
...
In this chapter, we develop geometric diffusion neural processes which incorporate geometrical prior knowledge into functional diffusion models.
...
\begin{figure*}
	...
	\end{subfigure}
	\caption{\emph{Top:} 1000 samples from the training data. \emph{Bottom:} 1000 samples from the trained model.}
