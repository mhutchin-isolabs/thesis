...
The proof of \cref{prop:implicit_der} drawing links between the denoising score matching loss and the implicit score matching loss is presented \cref{sec:manifold_ism_proof}.
