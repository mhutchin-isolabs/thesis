...
\begin{table}[t]
	...
	\adjustbox{width=\textwidth}{
		\begin{tabular}{lccc}
			...
			\midrule
			Barrier method (\Cref{cpt:constrained_domains})             & \cmark                  & \cmark & \cmark \\
			Reflected (\Cref{cpt:constrained_domains}, \textcite{lou2023reflected}) & \cmark                  & \cmark & \xmark \\
			Projection sampler \parencite{lou2023reflected}             & \cmark                  & \cmark & \xmark \\
			Metropolis sampler (This chapter)                                   & \cmark                  & \xmark & \xmark \\
			\bottomrule
		\end{tabular}
	}
\end{table}
