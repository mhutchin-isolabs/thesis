In Euclidean space, the axioms of Euclids elemets hold true.
Angles in a triangle sum up to 180\(^o\), 
...
%     \caption[short]{The space \includegraphics[height=1.5ex]{figures/diagrams/connected_disks.pdf} is disconnected as \(\includegraphics[height=1.5ex]{figures/diagrams/disk_blue.pdf} \^ \includegraphics[height=1.5ex]{figures/diagrams/disk_orange.pdf} = \emptyset\) and \(\includegraphics[height=1.5ex]{figures/diagrams/disk_blue.pdf} \u \includegraphics[height=1.5ex]{figures/diagrams/disk_orange.pdf} = \includegraphics[height=1.5ex]{figures/diagrams/connected_disks.pdf}\)}
% \end{figure}
...
% \begin{figure}[h]
%     \centering
%     \includegraphics{figures/diagrams/continuous_path.pdf}\hspace{1cm}\includegraphics{figures/diagrams/discontinuous_path.pdf}
...
\begin{theorem}[Divergence theorem]
	Let \((X, g)\) be an oriented Riemannain manifold with boundary, and \(X\in\Gamma(TX)\) with compact support.
	Then
	\[
		\int_X (\dive X) \d\vol_g = \int_{\partial X} \innerprod{X}{N}_g \d\vol_{\tilde g}
	\]
...
In a particalr chart \((\phi, U)\) the Riemannain divergence can be expressed as 
...
\subsubsection{Connections on the tangent bundle and tensor bundles}
...
\subsubsection{Vector fields on curves}
...
\subsubsection{The exponential and logarithm maps}
...
Manifolds for which \(\c{E} = TX\) are said to be \emphmarginnote{geodesically complete}.
