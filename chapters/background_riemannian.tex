...
\begin{theorem}[Bounded error of the Strum-Liouville decomposition]
...
\end{proof}
It can also be shown that this approximation is optimal in the sense that no other basis will obtain a better error bound than the truncated Strum-Liouville approximation \cite{aflalo2015optimality}.
