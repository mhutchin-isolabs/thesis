...
\begin{definition}[Partition of unity]
	\label[type]{def:partition_of_unity}
...
\begin{proof}
	...
	We can use these charts to create local bases for the tangent bundle, and a \emphhyperref{partition of unity}{} subordinate to the trivialisation to smoothly glue together local vector fields represented in these local bases into a global vector field.
\end{proof}
...
Bringing us full circle, the \emphhyperref{topology generated by this metric}{} is exactly the manifold topology we chose initially in constructing the topological manifold.
...
.\]
We can also define it via the \emphhyperref{Lie derivative}{def:lie_derivaite} as
\[
...
In this way, the connection can be seen as a generalisation (in the sense of the type of function it is) of the \emphhyperref{exterior derivative}{def:exterior_derivative}, as it will also map \((0,l)\)-tensors to \((0,l+1)\)-tensors.
...
The existence of a flat connection on a smooth manifold is equivalent to the tangent bundle being \emphhyperref{parallelisable}{}, as we can define non-vanishing coordinate fields on the manifold by parallel transporting a frame at a given point around the manifold.
...
,\]
either the \emphhyperref{Riemannian divergence}{def:riemannain_divergence} of the \emphhyperref{Riemannian gradient}{def:riemannian_gradient} of a smooth function, or as the \emphhyperref{trace}{} of the \emphhyperref{second covariant derivative}{def:second_covariant_derivaite} of the \emphhyperref
