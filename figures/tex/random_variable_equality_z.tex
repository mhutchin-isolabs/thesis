...
\begin{document}
    ...
    \begin{tikzpicture}[every fit/.style={rectangle,draw,inner sep=1mm,}]
        ...
        \node [] (f) at (0.5,2.1) {$f_3:\Omega \to X$};
        

        \node[draw,fit= (a) (d)] {};
        \node[draw,fit= (1) (4)] {};

        \draw[->,shorten <=-0.5mm,,shorten >=-0.5mm] (a) -- (2) {};
        \draw[->,shorten <=-0.5mm,,shorten >=-0.5mm] (b) -- (1) {};
        \draw[->,shorten <=-0.5mm,,shorten >=-0.5mm] (c) -- (4) {};
        \draw[->,shorten <=-0.5mm,,shorten >=-0.5mm] (d) -- (3) {};
