...
\begin{document}
    ...
    \begin{tikzpicture}
        \node (simple) at (0,0) {\includegraphics{/Users/mhutchin/Documents/thesis/figures/diagrams/boundary_charts2.pdf}};
        \node (math) at (-2,0.5) {\(U\)};
        ...
        \node (math) at (-0,1.0) {\(\phi\)};
        \node (math) at (-0,-0.7) {\(\psi\)};

        \node (math) at (2.5,0) {\(\psi \circ \phi^{-1}\)};
