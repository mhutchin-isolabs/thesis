...
\begin{document}
    ...
    \begin{tikzpicture}
        \node (simple) at (0,0) {\includegraphics{/Users/mhutchin/Documents/thesis/figures/diagrams/exponential_map.pdf}};
        \node (math) at (0.1,1.1) {\(p\)};
        \node (math) at (1.05,0.15) {\(q\)};
        \node (math) at (1.,.8) {\(v\)};
        \node (math) at (-0.0,0.2) {\(\exp(p, v)\)};
        \node (math) at (0.8,-.8) {\(\gamma_{p,v}(t)\)};
