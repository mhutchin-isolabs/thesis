...
\begin{figure}[ht] \centering \includegraphics[width=\textwidth]{images/steer_cnps/mnist/train_percentage.pdf} \caption{Qualitative examples of the behaviour of the predicted mean of different models when the context set size is changed.
		Digit not rotated.
	}
	\centering
