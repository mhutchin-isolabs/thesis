...
\begin{figure}
	\begin{tikzpicture}
		\node at (0,2.3375) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_a.pdf}};
		\node at (0,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_x.pdf}};
		\node at (2.26875,2.3375) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_b.pdf}};
		\node at (2.26875,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_y.pdf}};
		\node at (3.678125,2.3375) {\LARGE\ensuremath{\x}};
		\node at (3.678125,0) {\LARGE\ensuremath{\x}};
		\node at (5.3625,2.3375) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_vab.pdf}};
		\node at (5.3625,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_vxy.pdf}};
		\node at (6.7375,1.16875) {\Huge\ensuremath{=}};
		\node at (9.7625,1.1) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_xy.pdf}};
...
The kernel, on the other hand, is less obvious: because distinct tangent vectors live in different tangent spaces, it is unclear whether or not a Gaussian vector field is characterized by an appropriate notion of a matrix-valued kernel, or by something else.
...
At first this definition of a kernel function might seem surprising; why should it be defined on the \emph{cotangent} bundle of the manifold, rather than the tangent bundle?
...
\begin{figure}
	...
	\begin{tikzpicture}
		\node at (1.1,1.1) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_ex.pdf}};
		\node at (0,-0.9625) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_ey.pdf}};
		\node at (2.2,-0.9625) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_ez.pdf}};
		\node at (5.6375,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_ev.pdf}};
		\node at (10.0375,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/illustration/s2_pr.pdf}};
...
\begin{figure}
	\begin{tikzpicture}
		\node at (-3.5,0) {};
		\node[anchor=south] at (0,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/extra/torus.pdf}};
		\node[anchor=south] at (6,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/extra/klein_bottle.pdf}};
	\end{tikzpicture}
...
\begin{figure}
	\begin{tikzpicture}
		\node at (0,0) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/climate/s2_sphere.pdf}};
		\node at (6.5,0.12) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/climate/s2_flat.pdf}};
		\node at (0,4.5) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/climate/r2_sphere.pdf}};
		\node at (6.5,4.62) {\includegraphics[scale=0.25]{images/kernels_on_manifolds/climate/r2_flat.pdf}};
	\end{tikzpicture}
