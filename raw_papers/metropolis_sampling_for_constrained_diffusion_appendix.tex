...
\begin{proof}
	...
	To investigate the local properties of the drift near the boundary we rely on the notion of tubular neighborhood, see \cite[Theorem 6.24]{lee2012smooth}.
\end{proof}
...
Using the results of \cite{lee2012smooth}, we establish the existence of an open set of $\cl{\c{M}}$ (for the induced topology of $\R^d$) satisfying several important properties.
...
\begin{proof}
	...
	Using that $\sf{V} \subset \cbrcolon{x \in \cl{\c{M}}}{d(x,\partial \c{M}) \leq 2r} \subset \sf{U}$, \ref{item:c_prime} is a direct consequence of \cite[Theorem 6.24]{lee2012smooth}].
